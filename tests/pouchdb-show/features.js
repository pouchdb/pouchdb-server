...
describe('Sync show tests', () => {
  ...
  it('should fail when given an invalid response object', () => {
    return shouldThrowError(() => {
      return db.show('test/invalidRespObject');
    })
  ...
  it('invalid return type and provides', () => {
    db.show('test/invalidReturnTypeAndProvides')
  ...
  it('throwing error', () => {
    return shouldThrowError(() => {
      return db.show('test/throwingError');
    })
  ...
  it('throwing error in provides', () => {
    return shouldThrowError(() => {
      return db.show('test/throwingErrorInProvides');
    })
  ...
  it('show with doc', () => {
    ...
    .then(() => {
      return db.show('test/myshow/mytest');
    })
  ...
  it('unexisting show function', () => {
    return shouldThrowError(() => {
      return db.show('test/unexisting-show');
    })
  ...
  it('unexisting format', () => {
    return shouldThrowError(() => {
      return db.show('test/usingProviders', {query: {format: 'text'}});
    })
  ...
  it('no matching provider', () => {
    return shouldThrowError(() => {
      return db.show('test/usingProviders', {headers: {Accept: 'text/plain'}});
    })
  ...
  it('invalid syntax', () => {
    return shouldThrowError(() => {
      return db.show('test/invalidsyntax');
    })
  ...
  it('no doc with error response', () => {
    return shouldThrowError(() => {
      return db.show('test/throwingError/some-doc');
    })
...
describe('async show tests', () => {
  ...
  it('should fail with an unexisting ddoc', () => {
    ...
    .then((result) => {
      result.should.equal('db.show("abc/args") should not resolve');
    })
