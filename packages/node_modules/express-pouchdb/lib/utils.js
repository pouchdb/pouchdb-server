...
function setJsonOrPlaintext(res) {
  ...
  // Update 2025-08-27: that’s not entirely correct:
  // CouchDB will send application/json for almost any response
  // but if there are multiple options, as in a (now defunct) show
  // or list method, setting accept application/json will force
  // an application/json response
  // Not fixing this just yet in fear of breaking backwards compatibility
  // but we will want to address this when we have the CouchDB Test Suite
  // running against pouchdb-server.
...
exports.getUsersDBName = function (app) {
  return app.couchConfig.get('chttpd_auth', 'authentication_db');
};
