...
module.exports = function (app) {
  ...
  // Config
  app.get('/_node/:nodename/_config', function (req, res) {
    utils.sendJSON(res, 200, app.couchConfig.getAll());
  });

  app.get('/_node/:nodename/_config/:section', function (req, res) {
    utils.sendJSON(res, 200, app.couchConfig.getSection(req.params.section));
  });

  app.get('/_node/:nodename/_config/:section/:key', function (req, res) {
  ...
  app.put('/_node/:nodename/_config/:section/:key', utils.parseRawBody, putHandler);

  app.delete('/_node/:nodename/_config/:section/:key', function (req, res) {
    var section = req.params.section;
    var key = req.params.key;
    if (!whitelisted(section, key)) {
      return sendModificationNotAllowed(res);
