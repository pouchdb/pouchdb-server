...
module.exports = function (app) {
  ...
  // Config
  app.get(['/_config', '/_node/:nodename/_config'], function (req, res) {
    utils.sendJSON(res, 200, app.couchConfig.getAll());
  });

  app.get(['/_config/:section', '/_node/:nodename/_config/:section'], function (req, res) {
    utils.sendJSON(res, 200, app.couchConfig.getSection(req.params.section));
  });

  app.get(['/_config/:section/:key', '/_node/:nodename/_config/:section/:key'], function (req, res) {
  ...
  app.put(['/_config/:section/:key', '/_node/:nodename/_config/:section/:key'], utils.parseRawBody, putHandler);

  app.delete(['/_config/:section/:key', '/_node/:nodename/_config/:section/:key'], function (req, res) {
    var section = req.params.section;
    var key = req.params.key;
    if (!whitelisted(section, key)) {
      return sendModificationNotAllowed(res);
