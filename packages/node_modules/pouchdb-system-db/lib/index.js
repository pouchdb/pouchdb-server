...
function adminOnlyWrapper(error, orig, args) {
  ...
  // this is likely a bug in how adminOnlyWrapper() is called
  // in lieu of digging for that error, we paper over it here
  // TODO FIXME
  const db = args.db || args.base
  return db.getSecurity().then(function (security) {
