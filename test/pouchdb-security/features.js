...
describe('PouchDB-Security: tests', () => {
  beforeEach(() => {
    db = setup();
  });
  afterEach(teardown);
...
describe('PouchDB-Security: Installed security tests', () => {
...
describe('PouchDB-Security: Static security methdods installed', async () => {
  beforeEach(() => {
...
describe('PouchDB-Security: Async security tests', () => {
  beforeEach(() => {
    db = setup();
  });
  afterEach(teardown);
